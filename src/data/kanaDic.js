export const kanaDictionary = {
	hiragana: {
		...
		h_group4: {
			characters: { た: ['ta'], ち: ['chi', 'ti'], つ: ['tsu', 'tu'], て: ['te'], と: ['to'] }
		},
		...
		h_group12_a: {
			characters: { ざ: ['za'], じ: ['ji', 'zi'], ず: ['zu', 'du'], ぜ: ['ze'], ぞ: ['zo'] }
		},
		h_group13_a: {
			characters: { だ: ['da'], ぢ: ['ji', 'di', 'dzi'], づ: ['zu', 'dzu'], で: ['de'], ど: ['do'] }
		},
		...
		h_group17_a: {
			characters: { しゃ: ['sha', 'sya'], しゅ: ['shu', 'syu'], しょ: ['sho', 'syo'] }
		},
		h_group18_a: {
			characters: { ちゃ: ['cha', 'cya', 'tya'], ちゅ: ['chu', 'cyu'], ちょ: ['cho', 'cyo'] }
		},
	...
	katakana: {
		...
		k_group4: {
			characters: { タ: ['ta'], チ: ['chi', 'ti'], ツ: ['tsu', 'tu'], テ: ['te'], ト: ['to'] }
		},
		...
		k_group11_s: {
			characters: { シ: ['shi', 'si'], ツ: ['tsu', 'tu'], ソ: ['so'], ン: ['n'], ノ: ['no'] }
		},
		k_group12_s: {
			characters: {
				ウ: ['u'],
		...
		k_group14_a: {
			characters: { ザ: ['za'], ジ: ['ji', 'zi'], ズ: ['zu', 'du'], ゼ: ['ze'], ゾ: ['zo'] }
		},
		k_group15_a: {
			characters: { ダ: ['da'], ヂ: ['ji', 'di', 'dzi'], ヅ: ['zu', 'dzu'], デ: ['de'], ド: ['do'] }
		},
		...
		k_group19_a: {
			characters: { シャ: ['sha', 'sya'], シュ: ['shu', 'syu'], ショ: ['sho', 'syo'] }
		},
		k_group20_a: {
			characters: { チャ: ['cha', 'cya', 'tya'], チュ: ['chu', 'cyu'], チョ: ['cho', 'cyo'] }
		},
		...
		k_group29_a: {
			characters: { ファ: ['fa'], フィ: ['fi'], フェ: ['fe'], フォ: ['fo'], フュ: ['fyu'] }
		},
		k_group30_a: {
			characters: {
				ウィ: ['wi'],
